...
void FifoExecuterLowerBound::overlapTest2() {
  ...
  Operation i_0(0, 1, Operation::INSERT, 1);
  Operation i_1(2, 3, Operation::INSERT, 2);
  Operation i_2(4, 5, Operation::INSERT, 3);
  Operation i_3(6, 7, Operation::INSERT, 4);
...
void FifoExecuterLowerBound::overlapTest3() {
  ...
  input[5] = &r_1;
  Operation r_2(13, 16, Operation::REMOVE, 3);
  input[6] = &r_2;
...
void FifoExecuterLowerBound::overlapTest5() {
  ...
  Operation i_1(5, 7, Operation::INSERT, 2);
  input[1] = &i_1;

  Operation r_0(3, 4, Operation::REMOVE, 1);
  input[2] = &r_0;
...
void FifoExecuterLowerBound::overlapTest6() {
  ...
  Operation r_0(20, 21, Operation::REMOVE, 4);
  Operation r_1(22, 23, Operation::REMOVE, 3);
  Operation r_2(24, 25, Operation::REMOVE, 2);
  Operation r_3(26, 27, Operation::REMOVE, 1);
