  ...
  for queue in queues:
      ...
      for work in works:
          ...
          for thread in threads:
              ...
              template = "../ah-queues/scal/prodcon-{exe} -producers {thread} -consumers 1 -barrier -operations 10000 -c {work} {partials_param} {partials} -log_operations -noprint_summary -noset_rt_priority > {directory}{queue}-t{thread}{partials_param}{partials}-c{work}.txt"
